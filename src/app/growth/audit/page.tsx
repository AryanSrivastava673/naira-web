...
export const metadata: Metadata = {
  alternates: { canonical: 'https://nairamenus.in/growth/audit' },
  title: 'Free Restaurant SEO Audit | Naira Growth',
  description:
    'Run a free instant audit of your restaurant\'s online visibility. Naira Growth is a restaurant SEO agency trusted by 800+ restaurants across India. Local SEO, online reputation management, review monitoring, and digital marketing for restaurants — all in one platform.',
  keywords:
  ...
  openGraph: {
    ...
    type: 'website',
    url: 'https://nairamenus.in/growth/audit',
  },
}
